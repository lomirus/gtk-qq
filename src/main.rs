use relm4::{adw, gtk, send, AppUpdate, Model, RelmApp, Widgets};
...
impl Widgets<AppModel, ()> for AppWidgets {
                    ...
                    append = &HeaderBar {
                        ...
                        pack_end = &Button {
                            ...
                            connect_clicked(sender) => move |_| {
                                send!(sender, Message::LoginSuccessful);
                            },
                        },
    ...
    fn pre_view() {
        match model.page {
            Page::Login => self.stack.set_visible_child(&self.login_panel),
